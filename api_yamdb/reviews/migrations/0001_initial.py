# Generated by Django 2.2.16 on 2022-11-10 20:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(blank=True, default=None, null=True, validators=[django.core.validators.MinValueValidator(limit_value=1, message='Оценка должна быть больше или равна 1.'), django.core.validators.MaxValueValidator(limit_value=10, message='Оценка должна быть меньше или равна 10.')], verbose_name='Оценка')),
